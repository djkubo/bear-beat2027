...
| Tema | Documentos |
|------|------------|
| **Deploy / producción** | [DEPLOY_PRODUCCION.md](./DEPLOY_PRODUCCION.md), [VERIFICACION_RENDER_Y_SUPABASE.md](./VERIFICACION_RENDER_Y_SUPABASE.md), [DESPLIEGUE_Y_CAMBIOS_RECIENTES.md](./DESPLIEGUE_Y_CAMBIOS_RECIENTES.md), [CONFIGURACION_IA_Y_PRODUCCION.md](./CONFIGURACION_IA_Y_PRODUCCION.md), [RENDER_DEPLOY.md](../RENDER_DEPLOY.md), [AUDITORIA_PRODUCCION_Y_RUNBOOK.md](./AUDITORIA_PRODUCCION_Y_RUNBOOK.md) |
